...
می‌تونین خیلی راحت از نسخه آنلاین استفاده کنین یا اگه به فایل‌ کتاب می‌خوایین دسترسی داشته باشین، از بخش ریلیزهای گیت هاب([این لینک](https://github.com/Mariotek/reactjs-persian-interview-questions/releases)) به فرمت‌های مختلف دانلود کنین.
