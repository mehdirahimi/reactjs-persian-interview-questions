...
1.  ### ری‌اکت چیست؟
    ...
    ری‌اکت **کتابخانه‌ای متن‌باز** است که برای ساختن رابط کاربری به مخصوص برنامه‌های تک صفحه‌ای مورد استفاده قرار می‌گیرد. وظیفه ری‌اکت، مدیریت لایه view در برنامه‌های تحت وب و همچنین در بستر موبایل است. این کتابخانه که توسط برنامه نویسی از شرکت فیس‌بوک به نام [Jordan Walke](https://github.com/jordwalke) ایجاد شده، اولین بار در سال ۲۰۱۱ و در برنامه اینستاگرام مورد استفاده قرار گرفت.

    **[فهرست](#فهرست)**

2.  ### اصلی‌ترین ویژگی‌های ری‌اکت شامل چه چیزهایی است؟


    - استفاده از **VirtualDOM** به جای RealDOM در جهت کاهش هزینه تغییرات (چرا که یافتن، حذف یا بروز رسانی عناصر DOM پروسه‌ای زمان‌بر است)
    - پشتیبانی از **SSR(server side rendering)**
    - پیروی از جریان داده ها یا data binding به صورت **یک طرفه (unidirectional)**
    - استفاده از کامپوننت‌های ‌**reusable/composable** برای توسعه view
